...
ACTIVE_AUXILIARY_MODULES = [
    ...
    "app/engine/product_render_eval_cases.py",
    "app/engine/product_render_eval_harness.py",
    "app/engine/product_render_eval_runner.py",
    "app/engine/script_gen_eval_cases.py",
    "app/engine/script_gen_eval_harness.py",
